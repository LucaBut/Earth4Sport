    ...
    public class SimulatorService
    {
        ...
        public void Start() 
        {
            ...
            while (true)
            {
                ...
                ModifyGeoCoordinates(ref geoCoordinates, randLatLong, minValMovement, maxValMovement, moving);
        ...
        //              0.000500
        void ModifyGeoCoordinates(ref string geoCoordinates, int randLatLong, int minValMovement, int maxValMovement, bool moving)
        {
            ...
            if (randLatLong == 0)
            {
                ...
                else
                {
                    ...
                    if ((latitudeDecimals - movement) < minValMovement)
                    {
                        ...
                        int diff = (latitudeDecimals - movement) - minValMovement;
        ...
        string ComponingStringCoordinates(string geoCoordinates, int latitudeInt, int latitudeDecimals,
        ...
        void LimitsForMovement(string geoCoordinates, int randLatLong, ref int minValMovement, ref int maxValMovement)
        {
            int latitudeDecimals = 0, longitudeDecimals = 0, latitudeInt = 0, longitudeInt = 0;
        ...
        void SplitCoordinates(string geoCoordinates, ref int latitudeInt, ref int latitudeDecimals,
        ...
        void ModifyPulseRate(ref int pulseRate)
        {
            Random nRandom = new Random();
        ...
        void ReturnToNormalPulseRate(ref int pulseRate)
        {
            Random nRandom = new Random();
            int incrDecrease = 0;
